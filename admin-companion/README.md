...
The EAS project ID, Apple App ID, App Store Connect app ID, signing credentials, build, submission, and TestFlight assignment remain deliberately unset until their separately approved provider steps.
