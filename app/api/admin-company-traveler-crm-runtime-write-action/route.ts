import {
  adminCompanyTravelerCrmRuntimeWriteActionEnvGateName,
  executeAdminCompanyTravelerCrmRuntimeWriteAction,
} from "../../../lib/admin-company-traveler-crm-runtime-write-action";
...
function safeFailureResponse() {
  return Response.json(
    {
      ok: false,
      error: "Company/traveler CRM identity/contact write request failed safely.",
      env_gate_name: adminCompanyTravelerCrmRuntimeWriteActionEnvGateName,
      no_op: true,
      write_enabled: false,
    },
...
export async function POST(request: Request) {
  try {
    ...
    const result = await executeAdminCompanyTravelerCrmRuntimeWriteAction(
