...
} from "../../../lib/admin-driver-flight-eta-escalation-setup-foundation";
import {
...
function safeFailureResponse() {
  return Response.json(
    {
      error: "Admin driver flight ETA escalation setup request failed safely.",
      ok: false,
...
export async function GET(request: Request) {
  try {
    ...
    const setup = buildAdminDriverFlightEtaEscalationSetupFoundation({
