import {
  adminRateSettingsRuntimeWriteActionEnvGateName,
  executeAdminRateSettingsRuntimeWriteAction,
} from "../../../lib/admin-rate-settings-runtime-write-action";
...
function safeFailureResponse() {
  return Response.json(
    {
      ok: false,
      error: "Rate settings write request failed safely.",
      env_gate_name: adminRateSettingsRuntimeWriteActionEnvGateName,
      no_op: true,
      write_enabled: false,
    },
...
export async function POST(request: Request) {
  try {
    ...
    const result = await executeAdminRateSettingsRuntimeWriteAction(
