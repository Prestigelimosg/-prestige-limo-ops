...
Latest verified clean checkpoint before this public driver job action surface staging smoke record:
87328b9 Guard public driver job action surface
...
- Last verified repo checkpoint before this public driver job action surface staging smoke record: `87328b9 Guard public driver job action surface`.
- Latest implementation checkpoint to preserve: `87328b9 Guard public driver job action surface`; `origin/staging` points to `87328b96a2b92046a7290028b71c18ebbe897093`.
