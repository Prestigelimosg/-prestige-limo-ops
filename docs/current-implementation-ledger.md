...
Latest verified clean checkpoint before this public customer/driver visibility boundary guard:
f35b4d1 Record no-screenshot staging smoke for Load Bookings exposure guard

Latest staging-smoked app checkpoint:
bd0d012 Guard Load Bookings typed-read admin display exposure
...
- Last verified repo checkpoint before this public customer/driver visibility boundary guard: `f35b4d1 Record no-screenshot staging smoke for Load Bookings exposure guard`.
- Latest staging-smoked app checkpoint to preserve: `bd0d012 Guard Load Bookings typed-read admin display exposure`; `origin/staging` points to `bd0d012a96c6f2ed663a4a3a59f6c563eb102cc3`.
