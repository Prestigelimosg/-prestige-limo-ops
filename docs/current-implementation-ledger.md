...
- Future customer driver-progress display is not approved here; if separately approved, it may only use customer-safe summaries such as Driver assigned, Driver on the way, Driver arrived, Trip in progress, and Completed.
