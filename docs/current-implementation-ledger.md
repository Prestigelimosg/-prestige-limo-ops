...
4382cdf Add staging deployment approval packet guard
...
- Pre-activation verification suite is done at `da21fb5 Add pre-activation verification suite` and now includes `4382cdf Add staging deployment approval packet guard`; it fail-fast runs the global guard, activation matrix guard, staging deployment approval packet guard, channel/module no-live guards, production hardening guard, and shim cleanup guard.
