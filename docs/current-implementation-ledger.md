...
d19ee37 Add company traveler CRM write readiness preview API
...
- It always returns `actionEnabled false`, `writeEnabled false`, `liveWriteEnabled false`, and `adminReviewRequired true`.
