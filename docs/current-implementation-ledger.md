...
69c269d Wire company traveler identity display to typed APIs
...
- Latest repo commit to preserve as handoff baseline: `69c269d Wire company traveler identity display to typed APIs`.
- Latest implementation checkpoint to preserve: `69c269d Wire company traveler identity display to typed APIs`.
