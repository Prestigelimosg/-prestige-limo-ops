...
9aa4ab6 Retire unused legacy bookings shim surface
...
- Latest repo commit to preserve as handoff baseline: `9aa4ab6 Retire unused legacy bookings shim surface`.
- Latest implementation checkpoint to preserve: `9aa4ab6 Retire unused legacy bookings shim surface`.
