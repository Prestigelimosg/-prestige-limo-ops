...
export const adminLoadBookingsSafeDtoContractVersion =
  "admin-load-bookings-safe-dto-contract-v1";

export type AdminLoadBookingsSafeDtoContractInput = Record<string, unknown>;

export type AdminLoadBookingsSafeDtoFields = {
...
export type AdminLoadBookingsSafeDtoContractResult = {
  actionName: "load_bookings_safe_dto_contract";
  actionType: "load_bookings_safe_dto_contract";
  action_name: "load_bookings_safe_dto_contract";
  action_type: "load_bookings_safe_dto_contract";
  ...
  version: typeof adminLoadBookingsSafeDtoContractVersion;
  writeEnabled: false;
  write_enabled: false;
};
...
const fieldAliases = new Map<string, (typeof allowedCanonicalFields)[number]>([
  ...
  ["assigneddrivercontact", "assigned_driver_phone"],
  ["assigneddriverdisplayname", "assigned_driver_display_name"],
  ["assigneddrivername", "assigned_driver_display_name"],
  ["assigneddriverphone", "assigned_driver_phone"],
  ["assigneddriverplate", "assigned_driver_plate"],
  ["assigneddriverstatus", "assigned_driver_status"],
  ["assigneddrivervehicle", "assigned_driver_vehicle_type"],
  ["assigneddrivervehicletype", "assigned_driver_vehicle_type"],
  ...
  ["dropofflocation", "dropoff_address"],
  ["extra_stop_display", "extra_stop_display"],
  ["extrastopdisplay", "extra_stop_display"],
  ["id", "booking_id"],
  ["job_card_display", "job_card_display"],
  ["jobcarddisplay", "job_card_display"],
  ["pax", "pax_display"],
  ["pax_display", "pax_display"],
  ["paxdisplay", "pax_display"],
  ...
  ["servicetype", "service_display"],
  ["status", "booking_status"],
  ["traveler_display_name", "traveler_display_name"],
  ["travelerdisplayname", "traveler_display_name"],
  ["updated_at", "updated_at"],
  ["updatedat", "updated_at"],
  ["vehicle_display", "vehicle_display"],
  ["vehicle_type", "vehicle_display"],
  ["vehicledisplay", "vehicle_display"],
  ["vehicletype", "vehicle_display"],
]);
...
export function buildAdminLoadBookingsSafeDtoContract(
  input: AdminLoadBookingsSafeDtoContractInput = {},
): AdminLoadBookingsSafeDtoContractResult {
  const { forbiddenFields, normalized, readMode, unknownFields } = normalizeInput(input);
  const safeDto: AdminLoadBookingsSafeDtoFields = {
  ...
  const invalidFields = unique(
    allowedCanonicalFields
      .map((field) => (fieldInvalid(normalized, field, safeDto[field]) ? field : ""))
      .filter(Boolean),
  );
  const dtoFieldNames = Object.entries(safeDto)
  ...
  return {
    ...
    version: adminLoadBookingsSafeDtoContractVersion,
  };
}

export function fallbackAdminLoadBookingsSafeDtoContract() {
  return buildAdminLoadBookingsSafeDtoContract({});
}
