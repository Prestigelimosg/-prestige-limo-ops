...
export const adminWhatsAppMessageDisabledAdapterVersion =
  "admin-whatsapp-message-disabled-adapter-v1";

export type AdminWhatsAppDisabledMessageInput = {
...
export type AdminWhatsAppDisabledMessageResult = {
  ...
  status: "disabled";
  version: typeof adminWhatsAppMessageDisabledAdapterVersion;
};
...
export function prepareDisabledAdminWhatsAppMessage(
  input: AdminWhatsAppDisabledMessageInput,
): AdminWhatsAppDisabledMessageResult {
  return {
    delivery_surface: "whatsapp_disabled",
    ...
    status: "disabled",
    version: adminWhatsAppMessageDisabledAdapterVersion,
  };
}
