...
for (const phrase of [
  ...
  "The master control now gates the separately guarded automatic job-card workflow-status preparation pass. Calendar conflict checks, scheduled monthly invoice preparation, and automatic Driver Details Email remain disabled until their later separately guarded passes.",
