...
for (const phrase of [
  ...
  "The master control gates the separately guarded automatic job-card workflow-status preparation pass and the prepared-card read-only saved-job conflict check. Scheduled monthly invoice preparation and automatic Driver Details Email remain disabled until their later separately guarded passes.",
