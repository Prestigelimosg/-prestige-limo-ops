...
[
  ...
  "mt-1 min-h-10 w-full rounded-md border bg-white",
  "md:grid-cols-2 xl:grid-cols-4",
  "min-h-20 resize-y",
...
[
  ...
  'href="/book"',
].forEach((fragment) => assertIncludes(portalPage, fragment, `portal booking request handoff fragment`));
...
assertExcludes(
  ...
  "portal duplicate request form density marker",
);
assertExcludes(
  portalPage,
  "data-customer-portal-book-request-handoff",
  "portal duplicate booking request handoff marker",
);
