...
for (const requiredRule of [
  ...
  "The stored/customer PDF lower order remains locked as `sign-off → fully visible Bank Details → Notes → Terms & Conditions`",
  "Notes must remain immediately below the complete Bank Details block",
  "keep the sign-off visible, the closed `Bank Details` disclosure immediately below it",
  "one responsive bottom row containing the closed `Notes` and `Terms & Conditions` disclosures beside each other",
