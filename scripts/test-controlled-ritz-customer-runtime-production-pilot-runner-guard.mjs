...
const runnerPath = "scripts/run-controlled-ritz-customer-runtime-production-pilot.mjs";
...
for (const fragment of [
  "PRESTIGE_CONTROLLED_RITZ_PRODUCTION_PILOT_APPROVED",
  "controlled-ritz-production-pilot-approved",
  "expectedMaskedProductionProjectRef = \"kvv...atm\"",
  "targetLabel = \"Ritz Carlton\"",
  "one latest active Ritz Carlton booking",
...
assertIncludes(
  preactivationSuite,
  "scripts/test-controlled-ritz-customer-runtime-production-pilot-runner-guard.mjs",
  "preactivation suite registration",
);

console.log("Controlled Ritz customer runtime production pilot runner guard passed.");
