...
for (const fragment of [
  ...
  "safest wipe timing remains after the first real monthly scheduler proof due on 1 August 2026 at 08:00 SGT",
...
for (const fragment of [
  ...
  "Execution is deferred until after the first real monthly scheduler proof due on 1 August 2026 at 08:00 SGT, and must occur before real operations begin.",
  "fresh count-only inspection found 95 customers, 66 bookings, 5 test-only drivers, 13 customer invoice records, 7 completed closeouts, zero monthly invoice drafts, and 0 authentication users",
