...
assert.equal(config.ios.buildNumber, "13", "The final repaired Customer binary must be exact Build 13.");
...
for (const phrase of [
  ...
  "PR `#420` passed both Vercel checks",
  "`dpl_21cqk3oXMZYfe5f7ww6ZizBUSLnF`",
  "EAS build `87da252c-b107-485f-95bf-f79f928f1849`",
  "`706b3debbc2211334c523cfdd012e52ec52b128583337022da2c288888227c76`",
  "`b91be646-1c63-4c10-9059-35fdf9798f6c`",
  "Build 11 ID `05123adb-226d-49ae-ba70-7d3d40065f08`",
  "one tester and eleven builds",
  "Build 11 `IN_BETA_TESTING`",
  "external state remains `READY_FOR_BETA_SUBMISSION`",
