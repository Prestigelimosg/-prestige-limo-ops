...
for (const phrase of [
  ...
  "`/api/admin-bookings` accepts `/customers` and `/customers/*` as additional same-origin internal admin referers only for this exact customer-folder edit path; other admin routes keep their existing referer boundaries.",
