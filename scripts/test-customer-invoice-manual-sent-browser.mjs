...
try{
 ...
 console.log('Browser PASS: Paid tick → review → Mark as sent → same paid invoice in Total invoices → only linked job removed from pending; 390px button visible; no email or booking mutation.');
