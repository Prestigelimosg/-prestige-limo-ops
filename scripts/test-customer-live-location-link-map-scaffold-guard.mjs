...
for (const phrase of [
  ...
  "Future eligible service families include MNG/Arrival, DEP/Departure, TRF/Transfer, and DSP/Hourly through the scoped customer Driver Tracking panel.",
  "Future evidence must prove customer/account/booking scope, scoped MNG/Arrival eligibility, same-customer access only, wrong-customer blocked, stale/offline handling, POB/completed stop behavior, cleanup zero rows, rollback disabled, and no provider sends.",
