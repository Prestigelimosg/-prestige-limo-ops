...
for (const phrase of [
  ...
  "App-side runtime reads require `driver_live_location_runtime_settings` to be active in `runtime` mode, the capture flag open, explicit safe booking references, customer session/account resolution, booking ownership proof through `bookings`, and an eligible service family before reading any latest-position row; customer reads do not require the admin active-jobs map to be open.",
