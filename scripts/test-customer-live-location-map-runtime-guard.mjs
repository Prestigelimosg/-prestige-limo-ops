...
for (const phrase of [
  ...
  "`portal_account` customer links are scoped by the signed account plus exact booking ownership, mirroring `/api/customer-saved-bookings`; they are not blocked by the separate pilot customer runtime allowlist.",
