...
assert.ok(accessAccount.includes('"customer_account_reference, account_status, safe_display_label, company_id, booker_id, principal_cutover_at, legacy_link_revoked_at, updated_at"'));
