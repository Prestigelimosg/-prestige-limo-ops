...
for (const phrase of [
  ...
  "Eligible customer live-location service families include MNG/Arrival, DEP/Departure, TRF/Transfer, and DSP/Hourly through the scoped customer Driver Tracking panel.",
