...
const guardChecks = [
  {
    label: "Email AI existing Company + Booker account recovery",
    script: "scripts/test-email-ai-existing-account-recovery.mjs",
  },
  {
  ...
  {
    label: "Monthly Billing nine-booking Company + Booker repair guard",
  ...
  {
    label: "Monthly Billing eight-booking cancellation repair guard",
    script: "scripts/test-monthly-billing-eight-cancelled-repair-guard.mjs",
  },
  {
  ...
  },
  {
    ...
    script: "scripts/test-customer-invoice-booking-coverage-guard.mjs",
  },
  {
  ...
  {
    label: "Customer no-email invited identity and PIN access guard",
    script: "scripts/test-customer-invited-pin-access-guard.mjs",
  },
  {
  ...
  {
    label: "Admin Driver Job Link no-reload handoff guard",
    script: "scripts/test-admin-driver-job-link-no-reload-handoff-guard.mjs",
  },
  {
    label: "Driver native pre-ACK handoff guard",
    script: "scripts/test-driver-native-preack-handoff-guard.mjs",
  },
  {
  ...
  {
    label: "Customer companion in-app map navigation guard",
    script: "scripts/test-customer-companion-inapp-map-navigation-guard.mjs",
  },
  {
