...
for (const fragment of [
  ...
  "firstAgencySaveState.bookingInsert?.booking?.traveler_id, null",
  "firstAgencySaveState.bookingInsert?.booking?.passenger_name",
  "Expected successful Save + CRM to clear first agency mode",
]) {
  assert.ok(
