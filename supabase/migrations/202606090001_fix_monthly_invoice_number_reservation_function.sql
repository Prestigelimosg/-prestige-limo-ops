-- Fix monthly invoice number reservation RPC column qualification.
-- Created for review only; do not apply without explicit approval.
-- This replaces the sequence reservation function only. It does not create
-- invoice PDFs, send invoices, process payments, create payouts, notify users,
-- or activate customer/driver auth.
